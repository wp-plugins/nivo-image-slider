...
/* Slider Loop */
function sis_get_nivoslider(){
	$slider= '<div class="slider-wrapper theme-default"><div id="slider" class="nivoSlider">';
...
function sis_slider_wrapper_shortcode( $atts, $content = null ) {
        ...
        return '<div class="slider-wrapper theme-'.$theme.'">
        	<div id="'.$id.'" class="nivoSlider">'.do_shortcode($content).'</div></div>
        	<script type="text/javascript">
	    		jQuery(window).load(function() {
